...
Even though women tend to be more educated than men they seem on average more exposed to instability from external factors, susceptible to interrupt or ends their educational careers. We computed a dummy variable `precarity_educ_dummy` taking the value of 1 when the individual had to stop their educational path because of reasons such as "Pregnancy, maternity or paternity" or "Help around the house or household chores", and the value of 0 otherwise.
